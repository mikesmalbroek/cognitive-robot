...
cv2.imwrite('local_script_tests/aruro/aruro_codes/station_A_marker.png', marker0)

# Marker ID 1 voor Station B
marker1 = aruco.generateImageMarker(dict_, id=1, sidePixels=200)
cv2.imwrite('local_script_tests/aruro/aruro_codes/station_B_marker.png', marker1)